...
define("lunchbox/landingpage/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "t4yKOCI2", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"inbox\"],[\"flush-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"side\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"ul\",[]],[\"static-attr\",\"class\",\"side-items\"],[\"flush-element\"],[\"text\",\"\\n\"],[\"text\",\"    \"],[\"close-element\"],[\"text\",\"\\n  \"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"],[\"text\",\"\\n\"],[\"text\",\"\\n\"],[\"text\",\"\\n\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"about\"],[\"flush-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"\\n    LunchBox changes the way you experience home-delivered food! We bring you an\\n    awesome gourmet food experience , from the kitchens of talented  chefs in your\\n    area, who are encouraged to put their own creations on the menu as specialty\\n    items, which usually highlight hyper-local, seasonal fare.\\n    With food made from 100% non-GMO, organic ingredients, and clean proteins, we\\n    offer you tons of great options for lunch or dinner!\\n  \"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "lunchbox/landingpage/template.hbs" } });
});
