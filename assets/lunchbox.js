...
define('lunchbox/addmenu/route', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Route.extend({
    model: function model() {
      // debugger;
      var data = this.get('store').createRecord('menu', {});
      return data;
    },
    actions: {
...
define("lunchbox/addmenu/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "Wj0N2tuS", "block": "{\"statements\":[[\"append\",[\"helper\",[\"add-menu\"],null,[[\"menu\",\"saveMenu\",\"cancel\"],[[\"get\",[\"model\"]],\"saveMenu\",\"cancel\"]]],false],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "lunchbox/addmenu/template.hbs" } });
});
...
define('lunchbox/auth/service', ['exports', 'ember', 'ember-local-storage'], function (exports, _ember, _emberLocalStorage) {
  exports['default'] = _ember['default'].Service.extend({
    ...
    isChef: _ember['default'].computed.equal('credentials.email', 'admin@boogie.com'),
...
define('lunchbox/components/add-menu/component', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Component.extend({
    ...
    actions: {
      saveMenu: function saveMenu() {
        ...
        //   return;
        // }
        if (!this.get('menu.foodname') || !this.get('menu.fooddescription') || !this.get('menu.foodurl') || !this.get('menu.date') || !this.get('menu.price')) {
          this.get('flashMessages').warning('Oops! Looks like a field is missing!');
          return;
        }
...
define("lunchbox/components/add-menu/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "3nW3VSl1", "block": "{\"statements\":[[\"open-element\",\"form\",[]],[\"modifier\",[\"action\"],[[\"get\",[null]],\"saveMenu\"],[[\"on\"],[\"submit\"]]],[\"flush-element\"],[\"text\",\"\\n  \"],[\"append\",[\"helper\",[\"input\"],null,[[\"placeholder\",\"value\"],[\"Food Name\",[\"get\",[\"menu\",\"foodname\"]]]]],false],[\"text\",\"\\n  \"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\n  \"],[\"append\",[\"helper\",[\"textarea\"],null,[[\"rows\",\"cols\",\"placeholder\",\"value\"],[\"4\",\"86\",\"Food Description\",[\"get\",[\"menu\",\"fooddescription\"]]]]],false],[\"text\",\"\\n  \"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\n  \"],[\"append\",[\"helper\",[\"input\"],null,[[\"placeholder\",\"value\"],[\"Food Url\",[\"get\",[\"menu\",\"foodurl\"]]]]],false],[\"text\",\"\\n  \"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\n  \"],[\"append\",[\"helper\",[\"input\"],null,[[\"type\",\"placeholder\",\"value\"],[\"date\",\"Date\",[\"get\",[\"menu\",\"date\"]]]]],false],[\"text\",\"\\n  \"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\n  \"],[\"append\",[\"helper\",[\"input\"],null,[[\"placeholder\",\"value\"],[\"$ Price\",[\"get\",[\"menu\",\"price\"]]]]],false],[\"text\",\"\\n  \"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\n  \"],[\"open-element\",\"button\",[]],[\"flush-element\"],[\"text\",\"save\"],[\"close-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"button\",[]],[\"modifier\",[\"action\"],[[\"get\",[null]],\"cancel\"]],[\"flush-element\"],[\"text\",\"cancel\"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "lunchbox/components/add-menu/template.hbs" } });
});
...
define('lunchbox/components/edit-menu/component', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Component.extend({
    actions: {
...
define("lunchbox/components/edit-menu/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "9WUhjo7+", "block": "{\"statements\":[[\"block\",[\"each\"],[[\"get\",[\"menu\"]]],null,0]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"open-element\",\"form\",[]],[\"modifier\",[\"action\"],[[\"get\",[null]],\"editMenu\"],[[\"on\"],[\"submit\"]]],[\"flush-element\"],[\"text\",\"\\n  \"],[\"append\",[\"unknown\",[\"menu\",\"foodname\"]],false],[\"text\",\"\\n  \"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n  \"],[\"append\",[\"unknown\",[\"menu\",\"fooddescription\"]],false],[\"text\",\"\\n  \"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n  \"],[\"append\",[\"unknown\",[\"menu\",\"foodurl\"]],false],[\"text\",\"\\n  \"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n  \"],[\"append\",[\"unknown\",[\"menu\",\"date\"]],false],[\"text\",\"\\n  \"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\n  $ \"],[\"append\",[\"unknown\",[\"menu\",\"price\"]],false],[\"text\",\"\\n  \"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"button\",[]],[\"flush-element\"],[\"text\",\"Edit\"],[\"close-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"button\",[]],[\"modifier\",[\"action\"],[[\"get\",[null]],\"deleteMenu\"]],[\"flush-element\"],[\"text\",\"Delete\"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[\"menu\"]}],\"hasPartials\":false}", "meta": { "moduleName": "lunchbox/components/edit-menu/template.hbs" } });
});
...
define('lunchbox/components/my-application/component', ['exports', 'ember'], function (exports, _ember) {
  ...
  exports['default'] = _ember['default'].Component.extend({
    ...
    isChef: _ember['default'].computed.alias('auth.isChef'),
...
define("lunchbox/components/navbar-header/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "69MValiZ", "block": "{\"statements\":[[\"append\",[\"unknown\",[\"hamburger-menu\"]],false],[\"text\",\"\\n\"],[\"block\",[\"link-to\"],[\"application\"],[[\"class\"],[\"navbar-brand homepage\"]],0],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"Home\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "lunchbox/components/navbar-header/template.hbs" } });
});
...
define("lunchbox/components/user-type/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "VFy2+QOp", "block": "{\"statements\":[[\"open-element\",\"label\",[]],[\"static-attr\",\"for\",\"usertype\"],[\"flush-element\"],[\"text\",\"User Type\"],[\"close-element\"],[\"text\",\"\\n\"],[\"append\",[\"helper\",[\"input\"],null,[[\"type\",\"id\",\"placeholder\",\"value\"],[\"usertype\",\"usertype\",\"usertype\",[\"get\",[\"usertype\"]]]]],false],[\"text\",\"\\n\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "lunchbox/components/user-type/template.hbs" } });
});
...
define('lunchbox/editmenu/route', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Route.extend({
    model: function model() {
...
define("lunchbox/editmenu/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "YMi62F5p", "block": "{\"statements\":[[\"append\",[\"helper\",[\"edit-menu\"],null,[[\"menu\"],[[\"get\",[\"model\"]]]]],false],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "lunchbox/editmenu/template.hbs" } });
});
...
define("lunchbox/landingpage/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "6iaZUGSk", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"inbox\"],[\"flush-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"side\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"ul\",[]],[\"static-attr\",\"class\",\"side-items\"],[\"flush-element\"],[\"text\",\"\\n\"],[\"text\",\"    \"],[\"close-element\"],[\"text\",\"\\n  \"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"],[\"text\",\"\\n\"],[\"text\",\"\\n\"],[\"text\",\"\\n\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"landing\"],[\"flush-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"p\",[]],[\"static-attr\",\"class\",\"desc\"],[\"flush-element\"],[\"text\",\"\\n    LunchBox changes the way you experience home-delivered food! We bring you an\\n    awesome gourmet food experience , from the kitchens of talented  chefs in\\n    your area, who are encouraged to put their own creations on the menu as\\n    specialty items, which usually highlight hyper-local, seasonal fare.\\n    With food made from 100% non-GMO, organic ingredients, and clean proteins,\\n    we offer you tons of great options for lunch or dinner!\\n    \"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n    Daily Menus uploaded to our site gives you fresh options everyday. You can\\n    place orders days in advance or that day while supplies last.\\n  \"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "lunchbox/landingpage/template.hbs" } });
});
...
define('lunchbox/menus/route', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Route.extend({
    model: function model() {
      return this.get('store').findAll('menu', { reload: true }).then(function (menus) {
        return menus.sortBy('date');
      });
    },
    actions: {
      selectDate: function selectDate(id) {
...
define("lunchbox/myorders/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "R3/ZlbLh", "block": "{\"statements\":[[\"text\",\"\\n\"],[\"block\",[\"each\"],[[\"get\",[\"model\"]]],null,0],[\"text\",\"\\nCash on delivery!\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"  \"],[\"append\",[\"helper\",[\"my-order\"],null,[[\"myorder\",\"cancelOrder\"],[[\"get\",[\"myorder\"]],\"cancelOrder\"]]],false],[\"text\",\"\\n\"]],\"locals\":[\"myorder\"]}],\"hasPartials\":false}", "meta": { "moduleName": "lunchbox/myorders/template.hbs" } });
});
...
if (!runningTests) {
  require("lunchbox/app")["default"].create({"name":"lunchbox","version":"0.0.0+91466347"});
}
